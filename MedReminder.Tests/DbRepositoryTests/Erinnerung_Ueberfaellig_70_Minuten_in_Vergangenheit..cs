...
namespace MedReminder.Tests.DbRepositoryTests {
    public class Erinnerung_Ueberfaellig_70_Minuten_in_Vergangenheit : TestWithDbRepositoryAndEmptyDatabase {
        ...
        public Erinnerung_Ueberfaellig_70_Minuten_in_Vergangenheit() {
